    ...
    String parseMemoryForInstruction(String bitCommand)
    {
        ...
        if(iR!=null) {
            ...
            if (iR.type.equals("I")) {
                ...
                aluS=String.valueOf(alu);
                int aluIP = new BigInteger(aluS, 2).intValue();
                aluS = String.valueOf(aluIP);
