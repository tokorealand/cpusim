  ...
  private Cpu cpu;
    ...
    public void save() throws IOException
    {
        ...
        try {
            ...
            writerM = new BufferedWriter(new FileWriter(filePath+"mem"+fileName.substring(0,fileName.length()-1)+"txt"));
            writerS = new BufferedWriter(new FileWriter(filePath+"sim"+fileName.substring(0,fileName.length()-1)+"txt"));
     ...
     */
    void readMemFile() throws  IOException
    {
    ...
    /**
     * Parses the given line for bytes or simulator parameters.
